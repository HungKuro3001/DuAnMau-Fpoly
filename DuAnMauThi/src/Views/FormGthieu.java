 ...
 * @author 
 */
public class FormGthieu extends javax.swing.JFrame {

    /**
     * Creates new form FormGthieu
     */
    public FormGthieu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormGthieu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormGthieu().setVisible(true);
            }
        });
    }
